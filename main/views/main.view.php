...
<head>
	...
	<link href="<?php echo $GLOBALS['base_web_way']; ?>external.css" rel="stylesheet">
</head>

<?php 
if (isset($data['page']) && $data['page'] > 1)
	{
	$saved_page = ' data-saved-page="'.$data['page'].'"';
	}
else
	{
	$saved_page = '';
	...
	<header>
		<div class="navbar navbar-dark bg-dark shadow-sm">
			<div class="container d-flex justify-content-between">
				...
				if ($data['admin'] === 1)
					{
					$loginOut_link = ' href="#" onclick="ajax_logout()"';
					$loginOut_text = 'Выйти';
					}
				else
					{
					$loginOut_link = ' href="'.$GLOBALS['base_web_way'].'admin/"';
					$loginOut_text = 'Войти';
					}
				
				?>
				<a<?php echo $loginOut_link; ?> class="navbar-brand d-flex align-items-center">
					...
					<strong><?php echo $loginOut_text; ?></strong>
				</a>
			</div>
		</div>
	</header>
